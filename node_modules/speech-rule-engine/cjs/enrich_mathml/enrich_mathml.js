...
function isDescendant(child, node) {
    ...
    const guard = loopGuard(LOOP_LIMIT, () => { var _a; return `isDescendant cycle: ${child === null || child === void 0 ? void 0 : child.tagName} parent=${(_a = child === null || child === void 0 ? void 0 : child.parentNode) === null || _a === void 0 ? void 0 : _a.tagName}`; });
    do {
        guard();
