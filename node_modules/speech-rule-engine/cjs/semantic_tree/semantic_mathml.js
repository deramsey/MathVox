...
class SemanticMathml extends semantic_parser_js_1.SemanticAbstractParser {
    ...
    rows_(node, children) {
        ...
        if (children.length === 1) {
            ...
            const preserveEmpty = DomUtil.tagName(node) === semantic_util_js_1.MMLTAGS.MSTYLE;
            newNode =
                snode && snode !== node
                    ? snode
                    : semantic_processor_js_1.SemanticProcessor.getInstance().row(parsed, preserveEmpty);
        }
